...
import (
	...
	"github.com/Khanh1916/greenlight/internal/jsonlog"
	"github.com/Khanh1916/greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	if cfg.db.dsn == "" {
		...
		if cfg.db.dsn == "" {
			cfg.db.dsn = "postgres://greenlight:Khanh123xd@localhost/greenlight?sslmode=disable"
		}
	}
