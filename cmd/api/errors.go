...
// send 422 Unprocessable Entity and contents of errors map from Validator
func (app *application) failValidResponse(w http.ResponseWriter, r *http.Request, errors map[string]string) {
